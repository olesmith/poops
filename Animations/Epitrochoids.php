...
trait Epitrochoids
{
    function Epitrochoids_Parms()
    {
        $scale=$this->Parm("Scale");
        $r1=abs($this->Parm("r1"));
        
        $r2=abs($this->Max($this->Parm("T2"),$this->Parm("T1")));
        $d=abs($this->Parm("d"));
    ...
    function D_Epitrochoids_Point($t)
    {
        global $r2;
    ...
    function D2_Epitrochoids_Point($t)
    {
        global $r2;
    ...
    function Epitrochoids_Animate($t)
    {
        $r1=$this->Parm("r1");
